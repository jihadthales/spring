...
import ChoosePerfume from '../ChoosePerfume/ChoosePerfume';
import Product from "../Product/Product";
import OAuth2RedirectHandler from "../../utils/oauth2/OAuth2RedirectHandler";
import ChoosePerfumeH from '../ChoosePerfumeH/ChoosePerfumeH';
    ...
    return (
        <>
            ...
            <Switch>
                ...
                <Route exact path="/ChoosePerfume" component={ChoosePerfume}/>
                <Route exact path="/ChoosePerfumeH" component={ChoosePerfumeH}/>
