...
const NavBar: FC = () => {
    ...
    if (localStorage.getItem("isLoggedIn") || isLoggedIn) {
        ...
        links = (
            <>
                <li className="nav-item">
                    <Link to={"/login"} className="nav-link pl-5 pr-5">
    ...
    return (
        <div>
            <div id="header" className="container-fluid header-top d-none d-md-block pb-0 pt-0">
                <img src="https://i.ibb.co/FgLRWSg/logosw.jpg" className="rounded mx-auto d-block"/>
            </div>
                ...
                <nav id="navbar-main" className={`container navbar navbar-expand-lg bg-black text-white `}
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mr-auto ">
                            ...
                            <li className="nav-item">
                                <Link to={"/ChoosePerfume"}><span className="nav-link pl-5 pr-5">CHOOSE PERFUME</span></Link>
                            </li>
